  ...
  const saveMatchbox = async () => {
    try {
      ...
      if (editingMatchbox) {
        ...
        console.log('🔧 Erstelle neue Matchbox mit Ausstrahlungsdaten:', newMatchbox)
  ...
  const saveMatchingNight = async () => {
    try {
      ...
      if (editingMatchingNight) {
        ...
        console.log('🔧 Erstelle neue Matching Night mit Ausstrahlungsdaten:', newMatchingNight)
        await db.matchingNights.add(newMatchingNight)
